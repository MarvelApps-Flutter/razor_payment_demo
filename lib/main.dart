...
import 'screens/payment_successfull_screen.dart';
              ...
              Expanded(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    //     Row(
                    //       children: [
                    //         Image(image: AssetImage("assets/edit_icon.png"),height: 17),
                    //         Text("Edit")
                    //       ],
                    //     ),
                    //     Row(
...
//       appBar: AppBar(
//         backgroundColor: Colors.white,
//         title: Text("Payment Successful",style: TextStyle(color: Colors.black),),
//
//       ),body: Center(child: Text("Payment Successful",style: TextStyle(fontSize: 18),)),
//     );
//   }
// }